### CNN Run Script ###
setwd("~/OneDrive/CBI/HIV_ML_Project/Code and Data Files") #set to where the fasta files are
...
for (i in 1:length(input_list)){ 
  ...
  write.csv(imp_list[[1]],file=paste(infile,"imp.1.cnn.csv",sep=""))
  write.csv(imp_list[[2]],file=paste(infile,"imp.2.cnn.csv",sep=""))
  write.csv(imp_list[[3]],file=paste(infile,"imp.3.cnn.csv",sep=""))
  write.csv(imp_list[[4]],file=paste(infile,"imp.4.cnn.csv",sep=""))
  write.csv(imp_list[[5]],file=paste(infile,"imp.5.cnn.csv",sep=""))
