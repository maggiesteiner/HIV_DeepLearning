...
for (i in 1:length(input_list)){ 
  ...
  outfile=paste(infile,".brnn.output.txt",sep="")
  ...
  write.csv(imp_list[[1]],file=paste(infile,"imp.1.brnn.csv",sep=""))
  write.csv(imp_list[[2]],file=paste(infile,"imp.2.brnn.csv",sep=""))
  write.csv(imp_list[[3]],file=paste(infile,"imp.3.brnn.csv",sep=""))
  write.csv(imp_list[[4]],file=paste(infile,"imp.4.brnn.csv",sep=""))
  write.csv(imp_list[[5]],file=paste(infile,"imp.5.brnn.csv",sep=""))
  
  write.csv(rocout_list[[1]],file=paste(infile,"roc.1.brnn.csv",sep=""))
  write.csv(rocout_list[[2]],file=paste(infile,"roc.2.brnn.csv",sep=""))
  write.csv(rocout_list[[3]],file=paste(infile,"roc.3.brnn.csv",sep=""))
  write.csv(rocout_list[[4]],file=paste(infile,"roc.4.brnn.csv",sep=""))
  write.csv(rocout_list[[5]],file=paste(infile,"roc.5.brnn.csv",sep=""))
}